...
export const ARTICLES: Article[] = [
        ...
        {   
            ...
            author:'Sara Luque',
            comment:[{author:'hbib', content:"J'ai intégré l'informatique à l'université pour des raisons économiques, plus que tout. Le métier d'informaticien était considéré comme très lucratif à l'époque et obtenir ce diplôme était mon billet pour une vie plus stable financièrement.!"},{author:'ahmed', content:"La Tunisie compte beaucoup de femmes ingénieures. « Lors de mon stage de fin d’études à chez Talan en Tunisie, les équipes étaient mixtes. "}, {author:'emna', content:"C’est très bénéfique d’acquérir des connaissances, des idées, des expériences, mais c’est important aussi de savoir les transmettre"}]
        },
        {   
            id:2, 
            ...
            comment:[ {author:'emna', content:"C’est cet esprit de soutien et de partage qui m’a aidée à continuer ce que je fais et m’a incitée à y prendre part à mon tour"} ]
        },
        {   
            id:3,
            ...
            comment:[{author:'ahmed', content:"J'ai toujours aimé les chiffres, l'analyse de données. Comprendre et résoudre des problèmes. Alors quand il a fallu choisir mes études, je me suis orientée vers les stastiques."}
        , {author:'emna',content:"Article bien rédigé"}]
        },
        {   
            id:4,
            ...
            author:'Cécile Lafon',
            comment:[{author:'ahmed', content:"Ce parcours m'a ouvert les portes du métier de Data Scientist que j'exerce chez Talan depuis décembre dernier."},{author:'emna',content:"Article bien rédigé"}, {author:'rania', content:" C'est un métier passionant"}]
        ...
        {   
            ...
            comment:[{author:'ahmed', content:"La Tunisie compte beaucoup de femmes ingénieures. « Lors de mon stage de fin d’études à chez Talan en Tunisie, les équipes étaient mixtes. "},  {author:'emna', content:"C’est très bénéfique d’acquérir des connaissances, des idées, des expériences, mais c’est important aussi de savoir les transmettre"}, {author:'hbib', content:"C’est très bénéfique d’acquérir des connaissances, des idées, des expériences, mais c’est important aussi de savoir les transmettre"},{author:'kenza', content:"C’est très bénéfique d’acquérir des connaissances, des idées, des expériences, mais c’est important aussi de savoir les transmettre"}]},
        {
            id:5,
        ...
        {  
            ...
            author:' Brigitte Gouarin',
            comment:[{author:'ahmed', content:"La Tunisie compte beaucoup de femmes ingénieures. « Lors de mon stage de fin d’études à chez Talan en Tunisie, les équipes étaient mixtes. "},]
        },
